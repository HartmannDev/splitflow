...
export function AuthCard({
  ...
  const {
    ...
    resolver: zodResolver(schemaByMode[mode] as z.ZodType<AuthFormValues>),
    defaultValues: {
      name: "",
      lastname: "",
      email: "",
        ...
        <section className={styles.hero}>
          <div className={styles.heroCopy}>
            ...
            <h1 className={styles.heroTitle}>
              Stay on top of shared spending with less friction.
            </h1>
            <p className={styles.heroBody}>
              The experience is designed around quick review, clearer balances,
              and fewer surprises in the transaction flow.
            </p>
          </div>
          <div className={styles.heroList}>
            <div className={styles.heroListItem}>
              ...
              <div>
                Session-based access tied directly to backend business rules
              </div>
            </div>
            <div className={styles.heroListItem}>
              <div className={styles.heroListIcon}>
              ...
              <div>
                One unified app for dashboard, transactions, notifications, and
                admin
              </div>
            </div>
            <div className={styles.heroListItem}>
              ...
              <div>
                Modern product UI built for focus, hierarchy, and daily use
              </div>
            </div>
          </div>
        </section>
          ...
          {isLoginMode ? (
            <>
              ...
              <div className={styles.meta}>
                This uses the backend session cookie and current-user bootstrap
            ...
            <>
              ...
              <div className={styles.meta}>
                We’ll create your account and send a verification email before
                first login.
              </div>
            ...
            <>
              <div className={styles.meta}>
                This route is still scaffolded and ready for backend wiring.
              </div>
